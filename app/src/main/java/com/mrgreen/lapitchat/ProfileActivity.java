                            ...
                            if (task.isSuccessful()){
                                ...
                                .setValue("received").addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void aVoid) {
                                        ...
                                        HashMap<String, String> notoficationData = new HashMap<>();
                                        notoficationData.put("from", mCurrent_user.getUid());
                                        notoficationData.put("type", "request");

                                        mNotificationDatabase.child(user_id).push().setValue(notoficationData).addOnSuccessListener(new OnSuccessListener<Void>() {
                                                @Override
                                                public void onSuccess(Void aVoid) {
...
//                                        Toast.makeText(ProfileActivity.this, "Request Sent Successfully", Toast.LENGTH_LONG).show();
                                ...
                                Toast.makeText(ProfileActivity.this, "Faild Sending Request", Toast.LENGTH_LONG).show();
